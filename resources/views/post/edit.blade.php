...
@section('content')
    <div class="row">
                ...
                <div class="card-body">
                    <div class="tab-content p-0">
                        <div class="chart tab-pane active" id="full-content">
                            @include('alphanews::post.blocks._content-form')
                        </div>
                        <div class="chart tab-pane" id="preview">
                            @include('alphanews::post.blocks._short-content-form')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            @include('alphanews::post.blocks._status')
            @include('alphanews::post.blocks._publish')
            @include('alphanews::post.blocks._add-to-top')
            @include('alphanews::post.blocks._category')
            @include('alphanews::post.blocks._media-type')
            @include('alphanews::post.blocks._tags')
            @include('alphanews::post.blocks._image')
        </div>
    </div>
    @include('alphanews::post.blocks._crop-image-modal')
@stop
