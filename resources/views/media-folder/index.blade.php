...
@section('content')
    ...
    @if ($rootFolder !== null)
        ...
        @include('alphanews::media-folder._upload-image-modal')

    @endif
    <div class="row file-manager">
        @if ($rootFolder !== null)
            @component('alphanews::media-folder._preview', [
                'title' => 'Back',
                'link' => route('media-folders.index', ['id' => $rootFolder->media_folder_id]),
            ])
        ...
        @foreach($subFolders as $folderItem)
            @component('alphanews::media-folder._preview', [
               ...
               'link' => route('media-folders.index', $folderItem->id),
            ])
    ...
    @include('alphanews::media-folder._create-folder-modal')
@stop
